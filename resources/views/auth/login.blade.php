...
<div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="username" id="username" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('username') border-red-500 @enderror" value="{{ old('username') }}" required autofocus>
            @error('username')
